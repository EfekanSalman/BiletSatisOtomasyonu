...
public class RegisterPage extends JFrame {
    ...
    private void initializeComponents() {
        ...
        btnRegister.setBackground(new Color(70, 130, 180)); // Butonun arka plan rengini kırmızı yap
        btnRegister.setForeground(Color.WHITE); // Butonun metnini beyaz yap
        btnRegister.setFocusPainted(false); // Butona tıklandığında odak rengini gizler
        btnRegister.setBorderPainted(false); // Butonun kenar çizgisini gizler
        ...
        try {
            ...
            if (userDB.register(customer)) {
                try {
                    ...
                    // E-posta gönderilemese bile kayıt başarılı olduğu için devam ediyoruz
                }
    ...
    private boolean validateInput() {
        // boş girdi olmaması için yazıldı

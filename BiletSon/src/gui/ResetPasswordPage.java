...
public class ResetPasswordPage extends JFrame {
    ...
    private void initializeComponents() {
        ...
        btnReset.setBackground(Color.RED); // Butonun arka plan rengini kırmızı yap
        btnReset.setForeground(Color.WHITE); // Buton metnini beyaz yap
        btnReset.setFocusPainted(false); // Butona tıklandığında odak rengini gizler
        btnReset.setBorderPainted(false); // Butonun kenar çizgisini gizler
